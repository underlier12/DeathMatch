		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 id="modal-title" class="modal-title" style ="text-align:center;">Welcome To DeathMatch</h4>
				</div>
				<div class="modal-body">
					<!-- 이메일 -->
					<label for="userEmail1">아이디</label> 
					<div class="form-group">
						<input type="text"  style="width: 150px; display:inline-block;" class="form-control" id="userEmail1" name="userEmail1"
							placeholder="ID" maxlength="12" /> @
							<input type="text" style="width: 200px; display:inline-block;" class="form-control" id="userEmail2" name="userEmail2"/> 
